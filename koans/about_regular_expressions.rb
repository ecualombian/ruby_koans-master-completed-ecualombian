...
class AboutRegularExpressions < Neo::Koan
  ...
  # THINK ABOUT IT:
  #
  # Explain the difference between a character class ([...]) and alternation (|). Character class will ask "Is the next character one of the following?". Alternations will ask "Is the next set of characters X, if not then check Y, if not then check Z..."
